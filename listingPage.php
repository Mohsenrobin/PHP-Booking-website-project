...
if (
  ...
  if ($stmt = mysqli_prepare($conn, $sql)) {
    ...
    $sql = "SELECT a.accommodationID,accommodation_name,`description`,price_per_night,`location`,country,accommodationType, shortDesc , imageID, imageName FROM accommodation a, images i
