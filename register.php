...
<div class="registerBox">
    <form class="registerForm" action="register.php" method="POST">
        ...
        <input type="text" placeholder="Enter forename" name="forename" id="forename" required></br>

        <label for="surename"><b>Surname</b></label></br>
        <input type="text" placeholder="Enter surename" name="surename" id="surename" required></br>

        <label for="cusUsername"><b>Customer Username</b></label></br>
        <input type="text" placeholder="Enter Email" name="cusUsername" id="cusUsername" required></br>

        <label for="dob"><b>Date of birth</b></label></br>
        <input type="date" placeholder="Enter date of birth" name="dob" id="dob" value="2022-01-01" min="1930-01-01" max="2022-09-25" required></br>

        <label for="Postcode"><b>Postcode</b></label></br>
        <input type="postcode" placeholder="postcode" name="postcode" id="postcode" required></br>
        ...
        <input type="password" placeholder="Enter Password" name="password" id="password" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required></br>
