<?php
    ...
    if(isset($_POST['submit'])){
        ...
        mysqli_stmt_bind_param($stmt,"ssssssss",$cusUsername,$passeword,$forename,
        $surename,$postcode,$addressln1,$addressln2,$dob);
...
<html lang="en">
    ...
    <form class="container" action="register.php" method="POST">
        ...
        <label for="cusUsername"><b>Customer Username</b></label>
        ...
        <label for="addressln1"><b>Address Line 1</b></label>
        <input type="address line1" placeholder="Enter Address line 1" name="addressln1" id="addressln1" ></br>

        <label for="addressln2"><b>Address Line 2</b></label>
